...
- Zusätzlich werden die auf der Referenzanlage stark korrelierten Komponentenflags für Verdichter und interne Zusatzheizung sowie die belastbaren Bedarfsflags für Heizung, Brauchwasser und Kühlung als Attribute ausgegeben. Ungeklärte Bits (u. a. aus den beobachteten Positionen 0, 3, 16 und 21) erhalten bewusst keine erfundene Bedeutung.
...
- Numerische Diagnosehistorien behalten ihr bisheriges Min/Max/Mean/Last-Format; kategoriale Historien erhalten pro Minute First/Last/Transitions sowie eine zustandsbasierte Zusammenfassung. Während einer Zustandsmigration können numerische und kategoriale Historie als `mixed` gemeinsam erhalten bleiben.
