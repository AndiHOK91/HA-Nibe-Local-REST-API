...
POINT_BWZ_OPERATING_TIME = 3710
POINT_BWZ_STANDSTILL_TIME = 3711
...
POINTS: tuple[PointDef, ...] = (
    ...
    PointDef(158, "room_average_temperature_bt50", "Heizung"),
    ...
    PointDef(1865, "aux_heat_hot_water_total_time", "Warmwasser"),
    ...
    PointDef(2685, "periodic_hot_water_date", "Warmwasser"),
    ...
    PointDef(3708, "periodic_hot_water_start_time", "Warmwasser", "time"),
    ...
    PointDef(25165, "energy_log_current_power_consumption", "Energie"),
    PointDef(25166, "energy_log_current_power_components", "Energie"),
    PointDef(1975, "heating_circulation_pump_gp1", "Hydraulik"),
    PointDef(2792, "heating_circulation_pump_gp1_2792", "Hydraulik"),
    ...
    PointDef(599, "compressor_total_time_cooling", "S2125"),
    ...
    PointDef(22268, "last_defrost_heat_pump_1", "EEV / Abtauung", diagnostic=True),
    ...
    PointDef(248, "ventilation_exhaust_fan_speed", "Lüftung"),
    PointDef(249, "ventilation_supply_fan_speed", "Lüftung"),
